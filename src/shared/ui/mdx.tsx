...
import { ExternalLinkIcon, ArticleIcon, AnchorIcon } from "@/shared/ui/LinkIcons";
...
export const mdxComponents: Components = {
  ...
  a: ({ href, children }) => {
    ...
    return (
      ...
      >
        {kind === "internal" && <ArticleIcon className="cs-link-ic cs-link-ic--lead" />}
        {kind === "anchor" && <AnchorIcon className="cs-link-ic cs-link-ic--lead" />}
        {children}
        {kind === "external" && <ExternalLinkIcon className="cs-link-ic cs-link-ic--trail" />}
      </a>
    );
  },
  strong: ({ children }) => (
